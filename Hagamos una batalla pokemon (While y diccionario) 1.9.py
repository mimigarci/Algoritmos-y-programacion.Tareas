...
ataques = {"malicioso": (10, 0),
           "placaje1": (35* (100/defensa_oponente), 0),
           "ascuas": (20, 0),
           "latigo" : (10, 10),
           "placaje2": (35* (100/defensa_jugador), 0),
...
while PS_jugador > 0 and PS_oponente > 0:
    ...
    if ataque_jugador == ataque[0]:
        ...
        PS_oponente = PS_oponente - ataques["placaje1"][0]
        r_jugador["placaje"] += 1
    ...
    if ataque_jugador == ataque[0] or ataque_jugador == ataque[1] or ataque_jugador == ataque[2] :
        ...
        if ataque_oponente == 1: 
            PS_jugador = PS_jugador - ataques["latigo"][0]
            r_oponente["latigo"] += 1

            #Y la defensa del oponente es mayor o igual a 0, la defensa del jugador disminuirá en 10.
            if defensa_oponente >= 0:
                defensa_jugador = defensa_jugador - ataques["latigo"][1]
        ...
        #En caso de que el ataque del jugador sea placaje, su vida disminuirá en un 35* (100/defensa_jugador) 
            ...
            PS_jugador = PS_jugador - ataques["placaje2"][0]
        ...
        #Si el ataque del oponente es pistola de agua, el jugador perderá 40 puntos de vida.
            ...
            PS_jugador = PS_jugador - ataques["pistola de agua"][0]
